...
// import { StreamieInputItem, StreamieQueue } from '../StreamieQueue/types';
...
//     this.queue = createStreamieQueue(); // The items which have yet to be handled or are currently handling
